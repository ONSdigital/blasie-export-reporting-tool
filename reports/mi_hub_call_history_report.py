...
def get_mi_hub_call_history(config, questionnaire_name, questionnaire_id):
    ...
    print("mi_hub_cati_call_history")
    print("mi_hub_cati_call_history")
    print("mi_hub_cati_call_history")
    print(len(mi_hub_cati_call_history))
    print("questionnaire_data")
    print("questionnaire_data")
    print("questionnaire_data")
    print(len(questionnaire_data))
    print("mi_hub_cati_call_history_and_questionnaire_data_merged")
    print("mi_hub_cati_call_history_and_questionnaire_data_merged")
    print("mi_hub_cati_call_history_and_questionnaire_data_merged")
    print(len(mi_hub_cati_call_history_and_questionnaire_data_merged))

    return group_by_questionnaire(mi_hub_cati_call_history_and_questionnaire_data_merged)
