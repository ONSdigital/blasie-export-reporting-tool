...
def populate_call_history_model(item, questionnaire_id, questionnaire_name, cati_mi_hub_call_history_list):
...
def get_mi_hub_call_history(config, questionnaire_name, questionnaire_id):
    ...
    for item in cati_data:
        cati_mi_hub_call_history_list = populate_call_history_model(
            item,
            questionnaire_id,
            questionnaire_name,
            cati_mi_hub_call_history_list
