...
from models.appointment_resource_planning_language_summary_model import CatiAppointmentResourcePlanningSummaryLanguageTable
...
def get_cati_appointment_resource_planning_from_database_for_language_summary(config, date):
    return CatiAppointmentResourcePlanningSummaryLanguageTable.get_language_summary_for_date(config, date)
